...
public class ANPR {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println("--MY NUMBER PLATE DETECTION SOFTWARE--");
			System.out.print("\nPlease enter the path of image: ");
			String imgfile = sc.nextLine();
			
			//String imgfile = "vehicles_img/vehicle(20).jpg";  example of image path
			BufferedImage img = ImageIO.read(new File(imgfile));
			System.out.print("Computing band candidates...");
			...
			System.out.println("Performing band candidates selection...");
			...
			for (int i=0; i<candidate_num; i++) 
				...
				while (true) {	
					...
					if (sum!=candidate_num*100) {
						if (candidate_result[index][0] != 100) { 						
							displayImage(smallest_band,"Final Output(Band)");
							saveImage(smallest_band,"finalOutput_band.jpg");
							...
							saveImage(crop,"finalOutput_cropped.jpg");
							break;
						}
					}
				...
				System.out.println("Candidate "+(index+1)+" is the winner with the lowest score.");
				...
				for (int x=0; x<width; x++) {
					...
					if (r>=MIN_EDGE_INTENSITY) {
						...
						if (rect_width>=MIN_RECT_WIDTH) {
							...
							for (int l=start_index; l<(start_index+numOfTraverseAllowed); l++) {
								...
								if (rect_height>=MIN_RECT_HEIGHT) {
									...
									System.out.println("Success - Col:"+l+" till Col:"+end_index+" at Row:"+y+" and Row:"+y+" till Row:"+(y+rect_height-1)+" at Col:"+l);
									...
									System.out.println("Success - Col:"+l+" till Col:"+end_index+" at Row:"+y+" but fail Row:"+y+" till Row:"+(y+rect_height-1)+" at Col:"+l);
									rect_height = 0;
								}
							}
							rect_width = 0;
						...
						// width requirements not met
							...
							System.out.println("Fail - Col:"+start_index+" till Col:"+(start_index+rect_width-1)+" at Row:"+y);
							x = end_index+1;
							rect_width = 0;
						}
					}	
